...
class BaseComponent(object):
  ...
  def __init__(
      ...
      tfx_image: Text,
      kubeflow_metadata_config: Dict[Text, Text],
    ...
    Args:
      ...
      kubeflow_metadata_config: A dictionary of configuration settings for
    ...
    exec_properties[
        'beam_pipeline_args'] = pipeline.additional_pipeline_args.get(
            'beam_pipeline_args', [])
    exec_properties['log_root'] = log_root or '/var/tmp/tfx/logs'
